...
import com.example.newalpha.BuildConfig;
...
public class GeminiManager
{
    ...
    public void sendTextWithFilePrompt(String prompt, byte[] bytes, String minetypes, GeminiCallback callback)
    {
        List<Part> parts = new ArrayList<>();
        parts.add(new TextPart(prompt));
        parts.add(new BlobPart(minetypes, bytes));
        Content[] content = new Content[1];
        content[0] = new Content(parts);
